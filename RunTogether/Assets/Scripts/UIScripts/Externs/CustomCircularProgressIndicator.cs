...
namespace UIScripts.Externs
{
 class _ProgressIndicatorContants {
        ...
        public const float _kMinCircularProgressIndicatorSize = 20.0f;
    ...
    public class CustomCircularProgressIndicator : ProgressIndicator {
        public CustomCircularProgressIndicator(
            Key key = null,
            float? value = null,
            Color backgroundColor = null,
            Animation<Color> valueColor = null,
    ...
    class _CircularProgressIndicatorState : SingleTickerProviderStateMixin<CustomCircularProgressIndicator> {
    ...
    public class RefreshProgressIndicator : CustomCircularProgressIndicator {
