...
namespace UIScripts.RegisterPage
{
    ...
    {       
        ...
        public override Widget build(BuildContext context)
        {
            return new Scaffold(
                ...
                body: new StoreConnector<AppState, AppState>(
                    ...
                    builder: ((buildContext, model, dispatcher) => new Column(
                        children: new List<Widget>
                        {
                            ...
                            new Container(
                                ...
                                child: new RaisedButton(color: Colors.green,
                                    ...
                                    onPressed: model.CanGoToUserPage ? VerfyCode(context) : null,
                                    elevation: 0,
        ...
        private VoidCallback VerfyCode(BuildContext context)
        {
