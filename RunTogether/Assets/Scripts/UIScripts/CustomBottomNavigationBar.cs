...
namespace UIScripts
{
    ...
    public class CustomBottomNavigationBar : StatefulWidget
    {
        ...
        {
            return new _CustomBottomNavigationBarState();
        }
    }

    class _CustomBottomNavigationTile : StatelessWidget
    {
        public _CustomBottomNavigationTile(
...
//                        )
    ...
    class _CustomBottomNavigationBarState : TickerProviderStateMixin<CustomBottomNavigationBar>
    {
        ...
        public _CustomBottomNavigationBarState()
        {
        }
        ...
        public override void didUpdateWidget(StatefulWidget _oldWidget)
        {
            ...
            CustomBottomNavigationBar oldWidget = _oldWidget as CustomBottomNavigationBar;
    ...
    {
        public _Circle(
            _CustomBottomNavigationBarState state = null,
            int? index = null,
            Color color = null,
        ...
        public readonly _CustomBottomNavigationBarState state;
